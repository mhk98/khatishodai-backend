...
} = require("./subCategoryItem.constants");
...
const updateOneFromDB = catchAsync(async (req, res) => {
  ...
  console.log("subcategoryitem", req.body);
...
const deleteOneFromDB = catchAsync(async (req, res) => {
  ...
  const result = await SubCategoryItemService.deleteOneFromDB(id);
  sendResponse(res, {
    statusCode: 200,
    success: true,
    message: "SubCategoryItem deleted successfully!!",
    data: result,
  });
});
